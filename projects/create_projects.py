...
shared_css = """:root{--bg:#0f0f1a;--bg2:#1a1a2e;--card:#16213e;--card2:#1e2a45;--ink:#ffffff;--ink-s:#b8b8d1;--ink-d:#6a6a8a;--ac:#7c3aed;--ac2:#a855f7;--pink:#ec4899;--grad:linear-gradient(135deg,#7c3aed 0%,#ec4899 100%);--brd:#2d2d44;--shd:0 8px 32px rgba(124,58,237,.18);--r:16px;--mono:'JetBrains Mono',monospace;--disp:'Sora',sans-serif;--body:'Inter',sans-serif;}
